...
Improve Rust codebases by aligning ownership with design intent, composing meaningful error models, simplifying lifetimes, enforcing concurrency safety, and using zero-cost abstractions deliberately.
