...
INPUT_DEFINITIONS_DIR="$CONFIG_DIR_PROPS/common/system-defaults/backup-definitions"
OUTPUT_FILE="$CONFIG_DIR_PROPS/common/system-defaults/system-defaults.yml"
