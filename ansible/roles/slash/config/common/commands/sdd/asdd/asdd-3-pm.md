...
- In the prompts for Phase 1 and the first time Agent N appears, always instruct it to read .tmp/sdd/requirements.md. This will help the Agent understand its true purpose.
...
### Phase 1: [Name]
- **Agent 1 (Backend API)**: "Read `.tmp/sdd/requirements.md`. Execute Phase 1 tasks in `.tmp/sdd/tasks/phase_1.md` for Agent 1."
- **Agent 2 (Frontend)**: "Read `.tmp/sdd/requirements.md`. Execute Phase 1 tasks in `.tmp/sdd/tasks/phase_1.md` for Agent 2."
- **Sub-Agent 1 (Import cleanup)**: "Read `.tmp/sdd/requirements.md`. Execute Phase 1 tasks in `.tmp/sdd/tasks/phase_1.md` for Sub-Agent 1."
