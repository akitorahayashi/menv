...
alias tc="touch"
alias mkd="mkdir -p"
alias pdt="mkdir -p .tmp/pending && touch .tmp/pending/tasks.md"
alias pdr="mkdir -p .tmp/pending && touch .tmp/pending/requirements.md"
alias tk="mkdir -p .tmp && touch .tmp/tasks.md"
alias rv="mkdir -p .tmp && touch .tmp/review.md"
alias df="mkdir -p .tmp && touch .tmp/diff.md"
alias rq="mkdir -p .tmp && touch .tmp/requirements.md"
