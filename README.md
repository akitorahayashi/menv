...
7.  **macOS System Settings (`system` role)**
...
9.  **Visual Studio Code (`vscode` role)**
...
10. **Cursor Environment (`cursor` role)**
...
11. **Python Environment (`python-platform` and `python-tools` roles)**
...
14. **Claude Code Environment (`claude` role)**
...
17. **Docker Environment (`docker` role)**
