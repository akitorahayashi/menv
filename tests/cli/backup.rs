...
fn backup_help_shows_target_argument() {
    ...
    ctx.cli()
        ...
        .assert()
        .success()
        .stdout(predicate::str::contains("target").or(predicate::str::contains("Commands:")));
}
...
fn backup_alias_bk_is_accepted() {
    ...
    ctx.cli()
        ...
        .assert()
        .success()
        .stderr(predicate::str::contains("Available backup targets"));
}
...
fn backup_list_shows_targets() {
    ...
    ctx.cli().args(["backup", "list"]).assert().success().stderr(
