...
- `PERSONAL_VCS_NAME`: Personal Git configuration username
- `PERSONAL_VCS_EMAIL`: Personal Git configuration email address
- `WORK_VCS_NAME`: Work Git configuration username
- `WORK_VCS_EMAIL`: Work Git configuration email address